    ...
    private function getStaticModule()
    {
        static $modules = [
            ...
            [
                ...
                'url' => config('app.url').'/internetplans'
            ],
            [
                'name' => 'Servers',
                'icon' => 'fa fa-server',
            ...
            [
                ...
                'url' => config('app.url').'/ticketcategories'
            ],
            [
                ...
                'url' => config('app.url').'/billingcategories'
            ],
            [
                'name' => 'Employees',
                'icon' => 'fa fa-id-badge',
            ...
            [
                ...
                'url' => config('app.url').'/statementofaccount'
            ],
        ];

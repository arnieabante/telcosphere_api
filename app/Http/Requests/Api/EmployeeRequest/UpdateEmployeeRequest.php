...
class UpdateEmployeeRequest extends BaseEmployeeRequest
{
    ...
    public function rules(): array
    {
         return [
            ...
            'dateHired' => 'sometimes|required|string|min:2',
            'department' => 'nullable|string|min:2',
            'designation' => 'nullable|string|min:2',
            'workLocation' => 'nullable|string|min:2',
            'accessLevel' => 'sometimes|required|string',
            'shiftScheduleFrom' => 'nullable|string|min:2',
            'shiftScheduleTo' => 'nullable|string|min:2',
            'salaryRatePerDay' => 'sometimes|required|numeric|min:2',
            'hourlyRatePerDay' => 'sometimes|required|numeric|min:2',
            'paymentMethod' => 'sometimes|required|string|min:2',
            ...
            'employeeType' => 'sometimes|required|string',

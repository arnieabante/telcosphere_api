...
class StoreEmployeeRequest extends BaseEmployeeRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'shiftScheduleFrom' => 'string|min:2',
            'shiftScheduleTo' => 'string|min:2',
            'salaryRatePerDay' => 'required|string|min:2',
            'hourlyRatePerDay' => 'required|string|min:2',
            'paymentMethod' => 'string|min:2',
            'bankName' => 'string|min:2',
            'bankAccountNo' => 'bank_account_no|unique:employees',
            ...
            'tin' => 'string|tin|unique:employees',

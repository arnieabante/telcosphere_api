...
class ReplacePesoWifiHarvestRequest extends BasePesoWifiHarvestRequest
{
    /**
    ...
    {
        return [
            'pesoWifiClientId' => 'sometimes|required|numeric',
            'amountHarvested' => 'sometimes|numeric|min:0',
